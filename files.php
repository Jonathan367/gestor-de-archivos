...
<div id="menu-folder-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit">Cambiar nombre</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option delete">Eliminar</a>
</div>
<div id="menu-file-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit"><span><i class="fa fa-edit"></i> </span>Cambiar nombre</a>
...
<script>
	...
	$("div.custom-menu .delete").click(function(e){
		e.preventDefault()
		_conf("¿Estas seguro que quieres eliminar esta?",'delete_folder',[$(this).attr('data-id')])
	})
})
	...
	$("div.file.custom-menu .delete").click(function(e){
		e.preventDefault()
		_conf("¿Estas seguro que quieres eliminar este archivo?",'delete_file',[$(this).attr('data-id')])
	})
...
//FILE
	...
	function delete_folder($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast("La carpeta se borro correctamente.",'success')
						setTimeout(function(){
							location.reload()
						},1500)
				}
	...
	function delete_file($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast("El archivo se elimino correctamente.",'success')
						setTimeout(function(){
							location.reload()
						},1500)
				}
